...
### T.con-use: Concept use {#ss-concept-use}
...
### T.concepts.def: Concept definition rules {#ss-concepts-def}
...
### T.temp-hier: Template and hierarchy rules: {#ss-temp-hier}
...
### Template metaprogramming (TMP) {#ss-meta}
...
#### SL.io.3: Prefer `iostream`s for I/O {#rio-streams}
...
* [Boost Library Requirements and Guidelines](https://www.boost.org/development/requirements.html).
  ???.
* [BDE C++ Coding](https://github.com/bloomberg/bde/wiki/CodingStandards.pdf).
...
* [C++ Coding Standard](https://www.possibility.com/Cpp/CppCodingStandard.html).
  ???.
* [Secure C++ Coding Standard](https://wiki.sei.cmu.edu/confluence/x/Wnw-BQ).
...
* Stroustrup: [Style Guide](https://www.stroustrup.com/Programming/PPP-style.pdf)
  for [Principles and Practice using C++](https://www.stroustrup.com/programming.html).
...
#### Discussion: Define and initialize data members in the order of member declaration {#sd-order}
...
#### Discussion: Use of `=`, `{}`, and `()` as initializers {#sd-init}

???

#### Discussion: Use a factory function if you need "virtual behavior" during initialization {#sd-factory}
...
#### Discussion: Make base class destructors public and virtual, or protected and non-virtual {#sd-dtor}
...
#### Discussion: Usage of noexcept {#sd-noexcept}

???

#### Discussion: Destructors, deallocation, and swap must never fail {#sd-never-fail}
...
#### Discussion: Provide strong resource safety; that is, never leak anything that you think of as a resource {#cr-safety}
...
#### Discussion: Never return or throw while holding a resource not owned by a handle {#cr-never}
...
#### Discussion: A "raw" pointer or reference is never a resource handle {#cr-raw}
...
#### Discussion: Never let a pointer outlive the object it points to {#cr-outlive}
...
#### Discussion: Use templates to express containers (and other resource handles) {#cr-templates}
...
#### Discussion: Return containers by value (relying on move or copy elision for efficiency) {#cr-value-return}
...
#### Discussion: If a class is a resource handle, it needs a constructor, a destructor, and copy and/or move operations {#cr-handle}
...
#### Discussion: If a class is a container, give it an initializer-list constructor {#cr-list}
...
#### [Clang-tidy](https://clang.llvm.org/extra/clang-tidy/checks/list.html) {#St-clangtidy}
...
#### [CppCoreCheck](https://docs.microsoft.com/en-us/visualstudio/code-quality/using-the-cpp-core-guidelines-checkers) {#St-cppcorecheck}
