...
### Line Continuation
The line continuation [operator](https://www.mathworks.com/help/releases/R2025b/matlab/ref/ellipsis.html) is `...`.
...
#### `doc` Command
`doc` is pretty special. Especially if you don't like search Mathwork's website, 'cuz `doc <name>` opens *name's* documentation in a new tab in your system web browser. `doc` will pull up MATLAB's [index page](https://www.mathworks.com/help/releases/R2025b/index.html).
...
| `{}` | Cell array creation, [table indexing](https://www.mathworks.com/help/releases/R2025b/matlab/ref/curlybraces.html) | `{[1 2], rand(8)*4, "string"}`  |
...
- `gcf`: get current figure. \[[documentation](https://www.mathworks.com/help/matlab/ref/gcf.html)\]
- `clf`: deletes all children of the current figure that have visible handles. \[[documentation](https://www.mathworks.com/help/matlab/ref/clf.html)\]
- `clf(fig)`: deletes all children of the specified figure that have visible handles. \[[documentation](https://www.mathworks.com/help/matlab/ref/clf.html)\]
- `gca`: returns the current axes in the current figure. \[[documentation](https://www.mathworks.com/help/matlab/ref/gca.html)\]
- `shg`: makes the current figure visible and places it in front of all other figures on the screen. Identical to using the command `figure(gcf)`. \[[documentation](https://www.mathworks.com/help/matlab/ref/shg.html)\]
- `saveas(fig, filename[, format])`: creates the file using the specified file format, `formattype`. \[[documentation](https://www.mathworks.com/help/matlab/ref/saveas.html)\]
