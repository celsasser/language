...
The following list is a top 30 crates capture from [Most popular Rust Libraries](https://lib.rs/std){target="_blank"}. When I finish this document, I'm going to put it in a time-capsule bury it.
...
| Library                                                                         | Description                                                                                                                                                                                                             |
|---------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [serde](https://lib.rs/crates/serde){target="_blank"}                           | A generic serialization/deserialization framework                                                                                                                                                                       |
| [thiserror](https://lib.rs/crates/thiserror){target="_blank"}                   | derive(Error)                                                                                                                                                                                                           |
| [serde_json](https://lib.rs/crates/serde_json){target="_blank"}                 | A JSON serialization file format                                                                                                                                                                                        |
| [rand](https://lib.rs/crates/rand){target="_blank"}                             | Random number generators and other randomness functionality                                                                                                                                                             |
| [tokio](https://lib.rs/crates/tokio){target="_blank"}                           | An event-driven, non-blocking I/O platform for writing asynchronous I/O backed applications                                                                                                                             |
| [clap](https://lib.rs/crates/clap){target="_blank"}                             | efficient, and full-featured Command Line Argument Parser                                                                                                                                                               |
| [anyhow](https://lib.rs/crates/anyhow){target="_blank"}                         | Flexible concrete Error type built on std::error::Error                                                                                                                                                                 |
| [syn](https://lib.rs/crates/syn){target="_blank"}                               | Parser for Rust source code                                                                                                                                                                                             |
| [regex](https://lib.rs/crates/regex){target="_blank"}                           | regular expressions for Rust. This implementation uses finite automata and guarantees linear time matching on all inputs.                                                                                               |
| [base64](https://lib.rs/crates/base64){target="_blank"}                         | encodes and decodes base64 as bytes or utf8                                                                                                                                                                             |
| [log](https://lib.rs/crates/log){target="_blank"}                               | A lightweight logging facade for Rust                                                                                                                                                                                   |
| [tracing](https://lib.rs/crates/tracing){target="_blank"}                       | Application-level tracing for Rust                                                                                                                                                                                      |
| [tempfile](https://lib.rs/crates/tempfile){target="_blank"}                     | managing temporary files and directories                                                                                                                                                                                |
| [chrono](https://lib.rs/crates/chrono){target="_blank"}                         | Date and time library for Rust                                                                                                                                                                                          |
| [quote](https://lib.rs/crates/quote){target="_blank"}                           | Quasi-quoting macro quote!(...)                                                                                                                                                                                         |
| [reqwest](https://lib.rs/crates/reqwest){target="_blank"}                       | higher level HTTP client library                                                                                                                                                                                        |
| [libc](https://lib.rs/crates/libc){target="_blank"}                             | Raw FFI bindings to platform libraries like libc                                                                                                                                                                        |
| [proc-macro2](https://lib.rs/crates/proc-macro2){target="_blank"}               | A substitute implementation of the compiler’s proc_macro API to decouple token-based libraries from the procedural macro use case                                                                                       |
| [toml](https://lib.rs/crates/toml){target="_blank"}                             | A native Rust encoder and decoder of TOML-formatted files and streams. Provides implementations of the standard Serialize/Deserialize traits for TOML data to facilitate deserializing and serializing Rust structures. |
| [sha2](https://lib.rs/crates/sha2){target="_blank"}                             | Pure Rust implementation of the SHA-2 hash function family including SHA-224, SHA-256, SHA-384, and SHA-512                                                                                                             |
| [futures](https://lib.rs/crates/futures){target="_blank"}                       | streams featuring zero allocations, composability, and iterator-like interfaces                                                                                                                                         |
| [uuid](https://lib.rs/crates/uuid){target="_blank"}                             | generate and parse UUIDs                                                                                                                                                                                                |
| [tracing-subscriber](https://lib.rs/crates/tracing-subscriber){target="_blank"} | implementing and composing tracing subscribers                                                                                                                                                                          |
| [bytes](https://lib.rs/crates/bytes){target="_blank"}                           | Types and traits for working with bytes                                                                                                                                                                                 |
| [url](https://lib.rs/crates/url){target="_blank"}                               | based on the WHATWG URL Standard                                                                                                                                                                                        |
| [itertools](https://lib.rs/crates/itertools){target="_blank"}                   | Extra iterator adaptors, iterator methods, free functions, and macros                                                                                                                                                   |
| [once_cell](https://lib.rs/crates/once_cell){target="_blank"}                   | Single assignment cells and lazy values                                                                                                                                                                                 |
| [getrandom](https://lib.rs/crates/getrandom){target="_blank"}                   | A small cross-platform library for retrieving random data from system source                                                                                                                                            |
| [indexmap](https://lib.rs/crates/indexmap){target="_blank"}                     | A hash table with consistent order and fast iteration                                                                                                                                                                   |
...
`use` is an extremely useful and flexible keyword that was described to me to an "alias injector". [The Rust Reference](https://doc.rust-lang.org/reference/items/use-declarations.html){target="_blank"} has the following to say about `use`:
...
`import` is how I view him, but I don't think it's a good memory model. "import" implies action, and makes it sound like `use` is doing more than he does. `use` frees us from having to type out the full path. And he has some flavor crystals that we will see a little later.
...
##### `use` Scores a Perfect 10
::: {.subheading}
on his floor routine at the 2028 Summer Olympics
:::
...
Dependencies from [crates.io](https://crates.io/){target=_blank} (Rust's public registry, the equivalent of PyPI) go in `Cargo.toml`:
...
The operands are taken *by value* because addition is modeled as **consumption and transformation** — you take the inputs and produce a new output. For types where this makes sense (like integers), the values are [`Copy`](https://doc.rust-lang.org/std/marker/trait.Copy.html){target="_blank"}, so "moving" them is a no-op anyway. The compiler just copies the bits and you never notice.
...
[`String`](https://doc.rust-lang.org/std/string/struct.String.html){target="_blank"} stores three things: a pointer to heap memory, a length (bytes used), and a capacity (bytes allocated). It is *not* null-terminated. The length field is what tells Rust where the string ends.

[`&str`](https://doc.rust-lang.org/std/primitive.str.html){target="_blank"} is a **fat pointer**: a pointer into some UTF-8 buffer plus a length. It borrows that buffer — it owns nothing and cannot outlive the data it points into.
...
We will learn more about [Option\<T\>](#option-t) and how to use it in the chapter on [Enums](#enums). For now, know that `Option<T>` is how Rust represents a value that can either be something (`Some`) or nothing (`None`).
...
We will learn more about traits in the [Structs, Enums and Traits](#structs-enums-and-traits) section. And we will learn more about trait bounds in the [Generics and Trait Bounds](#generics-and-trait-bounds) section.
:::
...
### Functions
Functions are beautiful, reusable blocks of logic. [Wikipedia](https://en.wikipedia.org/wiki/Function_(computer_programming){target="_blank"}) describes a **function** as "a callable unit of software logic that has a well-formed interface and behavior and can be invoked multiple times... Their primary purpose is to allow for the decomposition of a large and/or complicated problem into chunks that have relatively low cognitive load and to assign the chunks meaningful names (unless they are anonymous). Judicious application can reduce the cost of developing and maintaining software, while increasing its quality and reliability." Where would any language be without them?
...
We cover [closures](https://doc.rust-lang.org/book/ch13-01-closures.html){target="_blank"} in more detail [below](#closures).
...
We go deeper in the [Option\<T\>](#optiont) (next section).
...
#### The Big Idea: A Two-Sided Framework
...
#### When You Don't Have a Struct: `serde_json::Value`
...
#### A Practical Pattern: Loading a Config File
